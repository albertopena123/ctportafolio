...
<script src="{{ asset('js/asignaturas.js?v='.config('app.version')) }}" type="text/javascript"></script>
@endsection
@section('contenido')
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card">
                    ...
                    <div id="t_principal">
                        <table id="t_asignaturas" class="table card-table table-vcenter text-nowrap datatable" width="100%">
                            <thead>
                                <tr>
                                    <th>DEPARTAMENTO</th>
                                    <th>CÓDIGO</th>
