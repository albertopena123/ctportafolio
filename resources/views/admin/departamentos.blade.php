...
@section('titulo', 'Departamentos académicos')

@section('js')
<script src="{{ asset('lib/datatables/datatables.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('js/departamentos.js?v='.config('app.version')) }}" type="text/javascript"></script>
@endsection
@section('contenido')
        ...
        <div class="row row-cards">
            <div class="col-12">
                <div class="card">
                    ...
                    <div id="t_principal">
                        <table id="t_departamentos" class="table card-table table-vcenter text-nowrap datatable" width="100%">
                            <thead>
                                <tr>
                                    <th>FACULTAD</th>
                                    <th>NOMBRE</th>
                                    <th>DESCRIPCIÓN</th>
                                    <th title="ESCUELAS PROFESIONALES">ESCU.</th>
                                    <th title="ASGINATURAS">ASIG.</th>
                                    <th>ESTADO</th>
                                    <th>ACCIONES</th>     
                                </tr>
                            </thead>
