...
const size_maximo = 52428800;//50 MB
var default_server = "";
...
function limpiar(ident_form) {
    $(ident_form+" .form-group").each(function() {
        var l_textbox = $(this).find('input[type=text], input[type=email], input[type=password], input[type=checkbox], input[type=file]');//es un textbox
